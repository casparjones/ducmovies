...
class MitarbeiterGui(object):
    ...
    def save_mitarbeiter(self, form, mitarbeiter):
        ...
        mitarbeiter["Filiale"] = form["Filiale"].get('0.0', END).rstrip()
    ...
    def edit_create_mitarbeiter(self, mitarbeiter=None):
        ...
        form = {
            ...
            "Filiale": Text(self.mainframe, height=1, width=30)
        }

        self.mainwindow.add_form_textfield("Name", mitarbeiter, 2, form)
        self.mainwindow.add_form_textfield("Vorname", mitarbeiter, 3, form)
        self.mainwindow.add_form_textfield("Filiale", mitarbeiter, 4, form)
        self.mainwindow.add_form_textfield("Gehalt", mitarbeiter, 5, form)

        Button(self.mainframe, text="save", command=lambda inner_form=form: self.save_mitarbeiter(inner_form, mitarbeiter)) \
